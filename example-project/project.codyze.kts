...
project {
    ...
    requirements {
        category("CRA") {
            ...
            //                description =
            //                    "Products with digital elements shall be made available on the
            // market with a secure by default configuration, " +
            //                        "unless otherwise agreed between manufacturer and business
            // user in relation to a tailor-made product " +
            //                        "with digital elements, including the possibility to reset the
            ...
            //                name = "X.1.1.4"
            //                description =
            //                    "Products with digital elements shall ensure that vulnerabilities
            // can be addressed through security updates, including, where applicable, through
            // automatic security updates that are installed within an appropriate timeframe enabled
            // as a default setting, with a clear and easy-to-use opt-out mechanism, through the
            // notification of available updates to users, and the option to temporarily postpone
            // them;"
            //
            //                fulfilledBy {
            ...
            //                name = "X.1.1.5"
            //                description =
            //                    "Products with digital elements shall ensure protection from
            ...
            //                name = "X.1.1.7"
            //                description =
            //                    "Products with digital elements shall protect the integrity of
            // stored, transmitted or otherwise processed data, personal or other, commands,
            // programs and configuration against any manipulation or modification not authorised by
            // the user, and report on corruptions;"
            //
            //                fulfilledBy {
            //                    with(BSI_TR02102()) {
            ...
            //                name = "X.1.1.8"
            //                description =
            //                    "Products with digital elements shall process only data, personal
            // or other, that are adequate, relevant and limited to what is necessary in relation to
            // the intended purpose of the product with digital elements (data minimisation);"
            //
            //                fulfilledBy {
            ...
            //                name = "X.1.1.9"
            //                description =
            //                    "Products with digital elements shall protect the availability of
            // essential and basic functions, also after an incident, including through resilience
            // and mitigation measures against denial-of-service attacks;"
            //
            //                fulfilledBy {
            ...
            //                name = "X.1.1.10"
            //                description =
            //                    "Products with digital elements shall minimise the negative impact
            // by the products themselves or connected devices on the availability of services
            ...
            // produced to limit attack surfaces, including external interfaces;"
            //
            //                fulfilledBy {
            ...
            //                description =
            //                    "Products with digital elements shall be designed, developed and
            // produced to reduce the impact of an incident using appropriate exploitation
            ...
            //                name = "X.1.1.14"
            //                description =
            //                    "Products with digital elements shall provide the possibility for
            // users to securely and easily remove on a permanent basis all data and settings and,
            // where such data can be transferred to other products or systems, ensure that this is
            // done in a secure manner."
            //
            //                fulfilledBy {
            //                    with(BSI_TR02102()) { secureHttpRequests() and
            // secureHttpResponses() } and
            //                        allowDeletionOfData(
            //                                trigger = { false },
            //                                getIdentity = { null },
