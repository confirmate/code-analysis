...
import de.fraunhofer.aisec.cpg.graph.concepts.crypto.encryption.CipherOperation
...
fun Node.alwaysCorrectlyEncrypted(): QueryTree<Boolean> {
    val relevantEncryptOperations = mutableListOf<CipherOperation>()
...
//        value = false,
//        stringRepresentation =
//            "Cipher ${this.cipherName} with key size ${this.keySize} is NOT considered state of
// the art",
//        node = this,
//        operator = GenericQueryOperators.EVALUATE,
//    )
