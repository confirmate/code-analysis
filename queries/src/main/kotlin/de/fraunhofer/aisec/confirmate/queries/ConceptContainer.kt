 ...
 */
class SymmetricCipher(blockSize: Int, keySize: Int, cipherName: String, underlyingNode: Node?) : Cipher(blockSize, keySize, cipherName, underlyingNode!!) {
 ...
 */
class HybridCipher(blockSize: Int, keySize: Int, cipherName: String, underlyingNode: Node?) : Cipher(blockSize, keySize, cipherName, underlyingNode!!) {
...
class TLS1_2_CipherSuite(
    ...
    underlyingNode: Node?,
): CipherSuite(authenticationMechanism,
    keyExchangeAlgorithm,
    macAlgorithm,
    ciphers, underlyingNode!!)
